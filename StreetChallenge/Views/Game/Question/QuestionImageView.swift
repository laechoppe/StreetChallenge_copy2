...
struct QuestionImageView: UIViewRepresentable {
    var image: UIImage
...
struct QuestionImageView_Previews: PreviewProvider {
    static var previews: some View {
        QuestionImageView(image: UIImage(imageLiteralResourceName: "image1"))
    }
}
